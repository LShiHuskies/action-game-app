...
const HighScoresList = ({ TOPSCORES, loading, GETCURRENTSCORES }) => {
  ...
  return (
    <div style={{ height: '40%' }}>
      <Card style={{ backgroundColor: 'black', marginTop: '5px', marginLeft: '15%', width: '70%', textAlign: 'center' }}>
        <h2 style={{ color: 'rgb(242, 121, 53)', marginTop: '1.5%', marginBottom: '1.5%' }}>Top Scores</h2>
      </Card>
        <div style={{ overflow: 'scroll', display: 'flex', flexWrap: 'wrap' }}>
          {TOPSCORES.map(game => {
            return (
              <Card sx={{ minWidth: 200 }} style={{ flex: '1 1 18%', backgroundColor: 'rgb(242, 121, 53)',
                margin: '5px',
                height: '150px',
                overflowY: 'scroll',
